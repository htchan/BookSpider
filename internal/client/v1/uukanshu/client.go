...
func (c *uukanshuClient) GetBookChapterList(ctx context.Context, bookID string) (client.ChapterEntryList, error) {
...
func (c *uukanshuClient) GetChapterContent(ctx context.Context, chapter client.ChapterEntry) (*client.ChapterContent, error) {
...
func (c *uukanshuClient) Available(ctx context.Context) bool {
