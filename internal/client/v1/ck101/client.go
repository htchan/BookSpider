...
type ck101Client struct {
	cli     *goclient.Client
	decoder *client.Decoder
}

var _ client.Client = (*ck101Client)(nil)
...
func (c *ck101Client) GetBookInfo(ctx context.Context, bookID string) (*client.BookInfo, error) {
...
func (c *ck101Client) GetBookChapterList(ctx context.Context, bookID string) (client.ChapterEntryList, error) {
...
func (c *ck101Client) GetChapterContent(ctx context.Context, chapter client.ChapterEntry) (*client.ChapterContent, error) {
...
func (c *ck101Client) Available(ctx context.Context) bool {
