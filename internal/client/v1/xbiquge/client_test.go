...
func TestNewClient(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			xbiqugeCli, ok := cli.(*xbiqugeClient)
			assert.True(t, ok)
			assert.NotNil(t, xbiqugeCli.cli)
			assert.NotNil(t, xbiqugeCli.decoder)

			// Test decoder can decode
			testStr := "test string"
			decoded, err := xbiqugeCli.decoder.Decode(testStr)
...
func TestClient_GetBookChapterList(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: client.ChapterEntryList{
				{URL: "https://www.xbiquge.bz/book/success/chapter url 1", Title: "chapter name 1"},
				{URL: "https://www.xbiquge.bz/book/success/chapter url 2", Title: "chapter name 2"},
				{URL: "https://www.xbiquge.bz/book/success/chapter url 3", Title: "chapter name 3"},
				{URL: "https://www.xbiquge.bz/book/success/chapter url 4", Title: "chapter name 4"},
			},
			wantErr: "",
		},
		{
