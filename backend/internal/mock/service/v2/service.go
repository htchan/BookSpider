...
// Source: github.com/htchan/BookSpider/internal/service_new (interfaces: Service)
...
func (m *MockService) Book(arg0 int, arg1 string) (*model.Book, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Book(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Book", reflect.TypeOf((*MockService)(nil).Book), arg0, arg1)
}
...
func (m *MockService) BookGroup(arg0 int, arg1 string) (*model.Book, *model.BookGroup, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BookGroup", arg0, arg1)
	ret0, _ := ret[0].(*model.Book)
...
func (mr *MockServiceMockRecorder) BookGroup(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BookGroup", reflect.TypeOf((*MockService)(nil).BookGroup), arg0, arg1)
}
...
func (m *MockService) PatchDownloadStatus() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PatchDownloadStatus")
	ret0, _ := ret[0].(error)
	return ret0
}

// PatchDownloadStatus indicates an expected call of PatchDownloadStatus.
func (mr *MockServiceMockRecorder) PatchDownloadStatus() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PatchDownloadStatus", reflect.TypeOf((*MockService)(nil).PatchDownloadStatus))
}
...
func (m *MockService) QueryBooks(arg0, arg1 string, arg2, arg3 int) ([]model.Book, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryBooks", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]model.Book)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) QueryBooks(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryBooks", reflect.TypeOf((*MockService)(nil).QueryBooks), arg0, arg1, arg2, arg3)
}

// RandomBooks mocks base method.
func (m *MockService) RandomBooks(arg0 int) ([]model.Book, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RandomBooks", arg0)
	ret0, _ := ret[0].([]model.Book)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) RandomBooks(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RandomBooks", reflect.TypeOf((*MockService)(nil).RandomBooks), arg0)
}
