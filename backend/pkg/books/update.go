...
func (book *Book) extractInfo() (string, string, string, string, string, error) {
	...
	if _, err := utils.Search(html, book.metaInfo.titleRegex);
		err != nil || !book.validHTML(html, book.metaInfo.baseUrl, trial) {
